...
public class CameraController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //transforms camera's rotation to look at 2 units above the player
        transform.LookAt(new Vector3(player.transform.position.x, player.transform.position.y + 2, player.transform.position.z), Vector3.forward);
